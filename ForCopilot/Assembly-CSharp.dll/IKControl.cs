	...
	private void OnAnimatorIK()
	{
		if (this.animator)
		{
			if (this.ikActive)
			{
				...
				{
					this.animator.SetIKPositionWeight(3, 1f);
					this.animator.SetIKRotationWeight(3, 1f);
					this.animator.SetIKPosition(3, this.rightHandObj.position);
					this.animator.SetIKRotation(3, this.rightHandObj.rotation);
					return;
				}
			}
			else
			{
				this.animator.SetIKPositionWeight(3, 0f);
				this.animator.SetIKRotationWeight(3, 0f);
