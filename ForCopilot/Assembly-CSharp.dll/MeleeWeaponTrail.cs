...
public class MeleeWeaponTrail : MonoBehaviour
{
	...
	// (set) Token: 0x06000249 RID: 585 RVA: 0x0000CB57 File Offset: 0x0000AD57
	public bool Emit
	{
		set
		{
	...
	// (set) Token: 0x0600024A RID: 586 RVA: 0x0000CB60 File Offset: 0x0000AD60
	public bool Use
	{
		set
		{
	...
	// Token: 0x0600024B RID: 587 RVA: 0x0000CB6C File Offset: 0x0000AD6C
	private void Start()
	{
	...
	// Token: 0x0600024C RID: 588 RVA: 0x0000CC8E File Offset: 0x0000AE8E
	private void OnDisable()
	{
		UnityEngine.Object.Destroy(this._trailObject);
	}

	// Token: 0x0600024D RID: 589 RVA: 0x0000CC9C File Offset: 0x0000AE9C
	private void Update()
	{
		if (!this._use)
		{
	...
	// Token: 0x0600024E RID: 590 RVA: 0x0000D66C File Offset: 0x0000B86C
