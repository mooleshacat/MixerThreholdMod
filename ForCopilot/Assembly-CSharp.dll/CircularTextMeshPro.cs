...
{
	// Token: 0x06000070 RID: 112 RVA: 0x000049F3 File Offset: 0x00002BF3
	private void Reset()
	{
		this.text = base.gameObject.GetComponent<TMP_Text>();
	}

	// Token: 0x06000071 RID: 113 RVA: 0x00004A06 File Offset: 0x00002C06
	private void Awake()
	{
		if (!this.text)
		{
	...
	// Token: 0x06000072 RID: 114 RVA: 0x00004A26 File Offset: 0x00002C26
	...
	// Token: 0x06000074 RID: 116 RVA: 0x00004A69 File Offset: 0x00002C69
	private void OnValidate()
	{
		this.WarpText();
	}

	// Token: 0x06000075 RID: 117 RVA: 0x00004A74 File Offset: 0x00002C74
	...
	// Token: 0x06000076 RID: 118 RVA: 0x00004ABC File Offset: 0x00002CBC
